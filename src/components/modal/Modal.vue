  ...
  <div class="modal">
    <ModalDialog>
      ...
      <ModalForm>
        ...
        <InputBlock class='modal__form-input' inputLabel="Новый пароль" inputPlaceholder='Введите новый пароль'
        ...
        <InputBlock class='modal__form-input' inputLabel="Повторите новый пароль"
        ...
        <InputCheckbox class='modal__form-checkbox' inputLabel='Завершить сеансы на других устройствах'
          inputType='checkbox' />

        <Button buttonText='Сменить пароль' class='modal__form-btn'
